...
export const herbTranslations: Record<string, Record<Language, HerbTranslation>> = {
	'peppermint-oil': {
		...
		fa: {
			...
			keyOutcome: 'فقط ۴ بیمار نیاز به درمان دارند تا ۱ نفر تسکین کامل علائم IBS را تجربه کند.',
	...
	'psyllium-husk': {
		...
		fa: {
			...
			keyOutcome: 'از کالج گوارش آمریکا "توصیه قوی" دریافت کرده و از نرم‌کننده مدفوع دوکوزات برتر است.',
	...
	'ginger': {
		...
		fa: {
			...
			keyOutcome: 'کارآزمایی‌های بالینی تسکین تهوع بسیار بهتری از پلاسبو در بارداری و شیمی‌درمانی نشان می‌دهند.',
	...
	'lavender-silexan': {
		...
		fa: {
			...
			keyOutcome: 'کارآزمایی‌های بالینی کاهش اضطراب قابل مقایسه با داروهای تجویزی لورازپام و پاروکستین را نشان دادند.',
	...
	'saffron': {
		...
		fa: {
			...
			keyOutcome: 'متاآنالیزها اثربخشی معادل فلوکستین (پروزاک) برای افسردگی را نشان می‌دهند، بدون عوارض جانبی جنسی.',
	...
	'valerian': {
		...
		fa: {
			...
			keyOutcome: 'بیماران استفاده‌کننده از سنبل‌الطیب تقریباً دو برابر بیشتر احتمال دارد بهبود کیفیت خواب را گزارش کنند.',
...
const additionalHerbTranslations: Record<string, Record<Language, HerbTranslation>> = {
	'pelargonium': {
		...
		fa: {
			...
			keyOutcome: 'در دستورالعمل‌های پزشکی رسمی برای درمان برونشیت شناخته شده؛ مطالعات تسکین سریع‌تر علائم را نشان می‌دهند.',
	...
	'garlic': {
		...
		fa: {
			...
			keyOutcome: 'متاآنالیزها کاهش فشار خون سیستولیک ۸-۹ میلی‌متر جیوه را نشان می‌دهند - قابل مقایسه با برخی داروهای تجویزی.',
	...
	'hibiscus': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات کاهش فشار خون بیش از ۷ میلی‌متر جیوه را نشان می‌دهند، با اثربخشی قابل مقایسه با مهارکننده ACE کاپتوپریل.',
	...
	'turmeric': {
		...
		fa: {
			...
			keyOutcome: 'کارآزمایی‌های مقایسه‌ای تسکین درد قابل مقایسه با ایبوپروفن و دیکلوفناک برای آرتروز زانو را نشان می‌دهند.',
	...
	'tea-tree-oil': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات بالینی بهبود آکنه مشابه بنزوئیل پراکسید و پاکسازی قارچ ناخن قابل مقایسه با کلوتریمازول را نشان می‌دهند.',
	...
	'black-cohosh': {
		...
		fa: {
			...
			keyOutcome: 'عصاره‌های استاندارد کاهش قابل توجه در فراوانی و شدت گرگرفتگی را در کارآزمایی‌های بالینی نشان می‌دهند.',
	...
	'cranberry': {
		...
		fa: {
			...
			keyOutcome: 'یک بررسی کاکرین کاهش ۲۶ درصدی عفونت‌های مکرر ادراری در زنان را تأیید می‌کند.',
	...
	'elderberry': {
		...
		fa: {
			...
			keyOutcome: 'متاآنالیزها کاهش قابل توجه در شدت علائم تنفسی فوقانی و تب در طی سرماخوردگی و آنفلوانزا را نشان می‌دهند.',
	...
	'honey': {
		...
		fa: {
			...
			keyOutcome: 'بررسی کاکرین تأیید می‌کند عسل تسکین سرفه بهتری در کودکان نسبت به دیفن‌هیدرامین یا پلاسبو ارائه می‌دهد.',
	...
	'capsaicin': {
		...
		fa: {
			...
			keyOutcome: 'تأیید شده توسط FDA برای بیماری‌های درد نوروپاتیک، با اثربخشی اثبات شده برای آرتروز دست و زانو.',
	...
	'st-johns-wort': {
		...
		fa: {
			...
			keyOutcome: 'یک بررسی کاکرین از نزدیک به ۵۵۰۰ بیمار اثربخشی برابر با SSRI‌ها را برای افسردگی خفیف تا متوسط نشان داد.',
	...
	'ginkgo-biloba': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات بهبود متوسط اما معنادار در عملکرد شناختی و مسافت راه رفتن بدون درد را نشان می‌دهند.',
	...
	'ashwagandha': {
		...
		fa: {
			...
			keyOutcome: 'کارآزمایی‌های بالینی کاهش قابل توجه در نمرات استرس و اضطراب را نشان می‌دهند، با سطوح کورتیزول ۲۳-۳۰ درصد کمتر.',
	...
	'rhodiola': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات متعدد بهبود قابل توجه در خستگی، عملکرد ذهنی و علائم فرسودگی را در چند هفته نشان می‌دهند.',
	...
	'butterbur': {
		...
		fa: {
			...
			keyOutcome: 'بالاترین رتبه‌بندی شواهد را از آکادمی نورولوژی آمریکا دریافت کرده؛ مطالعات ۵۰ درصد کاهش میگرن را نشان می‌دهند.',
	...
	'feverfew': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات بالینی کاهش فراوانی و شدت میگرن را پیشنهاد می‌کنند؛ رتبه "احتمالاً مؤثر" از متخصصان مغز و اعصاب.',
	...
	'boswellia': {
		...
		fa: {
			...
			keyOutcome: 'کارآزمایی‌های متعدد بهبود قابل توجه در درد آرتریت و عملکرد مفصل را نشان می‌دهند، اغلب در ۱-۲ هفته.',
	...
	'devils-claw': {
		...
		fa: {
			...
			keyOutcome: 'شواهد بررسی شده کاکرین تسکین درد قابل مقایسه با NSAIDها برای کمردرد را نشان می‌دهد، با عوارض گوارشی کمتر.',
	...
	'berberine': {
		...
		fa: {
			...
			keyOutcome: 'متاآنالیزها کنترل قند خون (کاهش HbA1c) قابل مقایسه با متفورمین را نشان می‌دهند، به علاوه کاهش قابل توجه LDL.',
	...
	'milk-thistle': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات بهبود سطوح آنزیم‌های کبدی و محافظت از سلول‌های کبدی در برابر آسیب سمی را نشان می‌دهند.',
	...
	'licorice-root': {
		...
		fa: {
			...
			keyOutcome: 'شواهد بالینی اثربخشی برای بهبود زخم معده و تسکین گلودرد و سرفه را تأیید می‌کنند.',
	...
	'echinacea': {
		...
		fa: {
			...
			keyOutcome: 'بررسی کاکرین مزایای متوسط را پیشنهاد می‌کند: علائم سرماخوردگی ممکن است ۱-۲ روز کوتاه‌تر و خفیف‌تر باشند.',
	...
	'saw-palmetto': {
		...
		fa: {
			...
			keyOutcome: 'مطالعات اولیه بهبود علائم ادراری را نشان دادند؛ کارآزمایی‌های بزرگ اخیر نتایج مختلط داشته‌اند.',
	...
	'horse-chestnut': {
		...
		fa: {
			...
			keyOutcome: 'بررسی کاکرین اثربخشی قابل مقایسه با جوراب‌های فشاری برای کاهش تورم و درد پا را تأیید می‌کند.',
